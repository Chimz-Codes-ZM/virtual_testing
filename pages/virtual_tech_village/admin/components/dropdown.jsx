...
const Dropdown = ({ options, newProject, setNewProject }) => {
  ...
  const handleCheckboxChange = (id) => {
    const isSelected = newProject.team_members.includes(id);
    if (!isSelected) {
      setNewProject({
        ...newProject,
        team_members: [...newProject.team_members, id],
      });
    } else {
      setNewProject({
        ...newProject,
        team_members: newProject.team_members.filter((memberId) => memberId !== id),
      });
    }
  };
            ...
            {options.map((option) => (
              ...
              >
                ...
                <input
                  ...
                  checked={newProject.team_members.includes(option.id)}
