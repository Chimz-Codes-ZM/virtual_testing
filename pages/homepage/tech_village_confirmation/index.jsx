...
const index = () => {
    ...
    return (
        <Layout><div className="flex flex-col items-center justify-center p-10 gap-4 relative bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r text-white">
